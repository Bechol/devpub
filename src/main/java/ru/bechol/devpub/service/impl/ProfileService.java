...
public class ProfileService implements IProfileService {
	 ...
	 */
	@Override
	public ResponseEntity<?> editProfile(Map<String, String> editParametersMap, User user) {
	...
	@Override
	public Response<?> editProfile(MultipartFile file, EditProfileRequest editProfileRequest, User user)
			throws IOException {
		Map<String, String> errorsMap = new HashMap<>();
		...
		CloudinaryResult cloudinaryResult = storageService.sendToCloudinary(file);
