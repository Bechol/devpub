...
public class PostService {
    ...
    public ResponseEntity<PostsResponse> findAllSorted(int offset, int limit, String mode) {
        List<PostsResponse.PostBody> resultList = prepareResponseResultList(offset, limit);
        switch (mode) {
            case "recent":
     ...
     */
    private List<PostsResponse.PostBody> prepareResponseResultList(int offset, int limit) {
